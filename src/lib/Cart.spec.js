...
describe('Cart', () => {
  ...
  describe('Special conditions', () => {
    ...
    it('should receive two or more conditions and determine/apply the a best discount. firt case.', () => {
      const condition1 = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the a best discount. second case.', () => {
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
